...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "view notes" in query or "show me notes" in query or "open" in query or "i want to see" in query:
            view_notes()

        
        if "delete" in query or "delete a note" in query or "i want to delete" in query:
            delete_note()
