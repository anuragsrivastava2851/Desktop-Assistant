    ...
    while True:
        ...
        for site_name, url in sites.items():
            if f"open {site_name}" in query:
                ...
                webbrowser.open(url)
                break            # here breaks means after opening youtube it will terminate the program
        ...
        # 
        # ############### may be dangourous to test thats why commented
        ...
        if "open" in query and any(app in query for app in ["notepad", "calculator", "paint", "word", "excel"]):
            # Extract app name
            for app in ["notepad", "calculator", "paint", "word", "excel"]:
                if app in query:
